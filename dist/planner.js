...
exports.planAssemblySequence = planAssemblySequence;
 ...
 */
function findFreeDirection(partId, matrix) {
    for (const dir of types_1.DIRECTIONS) {
 ...
 */
function removePartFromMatrix(removedId, matrix) {
    // 删除该零件自身的行
 ...
 */
function generateDisassemblySequence(parts, matrix) {
    // 深拷贝矩阵，避免修改原始数据
 ...
 * @returns       装配顺序的零件数组
 */
function planAssemblySequence(parts, matrix) {
